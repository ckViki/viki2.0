...
<div class="flex w-full  h-[100vh] text-white relative">
    <img src="/image/viki2.png" class="absolute imageFade z-10 left-[10%] md:left-[35%] md:-mt-[34px] md:h-[64vh]" alt="" style="color:transparent;">
    <div class="m-auto text-center animate" >
        ...
        <br>        
        <div class="text-[3vw] font-semibold -mt-20 m-auto">UI/UX Designer
            <br />
